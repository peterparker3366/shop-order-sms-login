...
> Design notes for **shop-order-sms-login** — a runnable typescript example that Typed Node service that verifies a shopper by SMS before returning order updates.
...
- **Feature code** — the actual task: ecommerce-sms-login.
